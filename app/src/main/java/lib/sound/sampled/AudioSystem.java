...
import lib.com.sun.media.sound.JDK13Services;
import lib.sound.sampled.spi.AudioFileReader;
import lib.sound.sampled.spi.AudioFileWriter;
import lib.sound.sampled.spi.FormatConversionProvider;
import lib.sound.sampled.spi.MixerProvider;
 ...
 *  </tr>
 *  <tr>
 *   <td><code>july.sound.sampled.Clip</code></td>
 *   <td>{@link Clip}</td>
 *   <td>{@link #getLine}, {@link #getClip}</td>
 *  </tr>
 *  <tr>
 *   <td><code>july.sound.sampled.Port</code></td>
 *   <td>{@link Port}</td>
 *   <td>{@link #getLine}</td>
 *  </tr>
 *  <tr>
 *   <td><code>july.sound.sampled.SourceDataLine</code></td>
 *   <td>{@link SourceDataLine}</td>
 *   <td>{@link #getLine}, {@link #getSourceDataLine}</td>
 *  </tr>
 *  <tr>
 *   <td><code>july.sound.sampled.TargetDataLine</code></td>
 ...
 * name of a concrete {@link lib.sound.sampled.spi.MixerProvider
 ...
 *
 * For example, the property <code>july.sound.sampled.Clip</code>
 * with a value
...
public class AudioSystem {
     ...
     * <code>july.sound.sampled.Clip</code>,
     * <code>july.sound.sampled.Port</code>,
     * <code>july.sound.sampled.SourceDataLine</code> and
     * <code>july.sound.sampled.TargetDataLine</code> are defined
     ...
     *
     * <p>If the system property
     * <code>july.sound.sampled.SourceDataLine</code>
     * is defined or it is defined in the file &quot;sound.properties&quot;,
     ...
     *
     * <p>If the system property
     * {@code july.sound.sampled.TargetDataLine}
     * is defined or it is defined in the file &quot;sound.properties&quot;,
    ...
    public static boolean isConversionSupported(AudioFormat targetFormat, AudioFormat sourceFormat) {
        ...
        List codecs = getFormatConversionProviders();
//        System.out.println(codecs.size());
//        System.out.println(codecs.get(0).getClass().getName());
//        System.out.println(codecs.get(1).getClass().getName());
//        System.out.println(codecs.get(2).getClass().getName());
//        System.out.println(codecs.get(3).getClass().getName());
//        System.out.println(codecs.get(4).getClass().getName());
        for(int i=0; i<codecs.size(); i++ ) {
            FormatConversionProvider codec = (FormatConversionProvider) codecs.get(i);
...
//        System.out.println(codecs.get(0).getClass().getName());
        for(int i = 0; i <= codecs.size(); i++) {
//            FormatConversionProvider codec = (FormatConversionProvider) codecs.get(i);
            FormatConversionProvider codec = (FormatConversionProvider) new lib.com.sun.media.codec.audio.mp3.JS_MP3ConversionProvider();
...
//        System.out.println(providers.size());
        for(int i = 0; i <= providers.size(); i++ ) {
          AudioFileReader reader = (AudioFileReader) (new lib.com.sun.media.codec.audio.mp3.JS_MP3FileReader());
     //	AudioFileReader reader = (AudioFileReader) (new lib.com.sun.media.sound.WaveFileReader());
            try {
     ...
     * @return an array of
     * {@link lib.sound.sampled.spi.FormatConversionProvider
     ...
     * @return a List of
     * {@link lib.sound.sampled.spi.AudioFileReader
     * AudioFileReader}
     ...
     * @return a List of
     * {@link july.sound.samples.spi.AudioFileWriter AudioFileWriter}
