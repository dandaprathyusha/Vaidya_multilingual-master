...
public class WaveData {
        ...
        private lib.sound.sampled.AudioFormat format;
        ...
        public lib.sound.sampled.AudioFormat getFormat() {
                return format;
        }
        ...
        public float[] extractFloatDataFromAmplitudeByteArray(lib.sound.sampled.AudioFormat format2, byte[] audioBytes) {
                // convert
                audioData = null;
                if (format2.getSampleSizeInBits() == 16) {
                        int nlengthInSamples = audioBytes.length / 2;
                        audioData = new float[nlengthInSamples];
                        if (format2.isBigEndian()) {
                        ...
                        audioData = new float[nlengthInSamples];
                        if (format2.getEncoding().toString().startsWith("PCM_SIGN")) {
